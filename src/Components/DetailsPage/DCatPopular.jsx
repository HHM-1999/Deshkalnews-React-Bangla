            ...
            {catName ?
                <>
                    <div className="DSecTitle2">
                        <h2> {catName} সর্বাধিক পঠিত খবর</h2>
                    </div>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-4 col-sm-4 col-5">
                                                        <div className="DImgZoomBlock">
                                                            {nc.ImageSmPath === null ?
                                                                <picture><img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_LAZYL_IMG} alt={nc.DetailsHeading} title={nc.DetailsHeading} 
                                                                style={{width: "100%", height:"100%"}} /></picture>
                                                                :
                                                                <picture><img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + nc.ImageSmPath} alt={nc.DetailsHeading} title={nc.DetailsHeading} 
                                                                style={{width: "100%", height:"100%"}} /></picture>}
