...
import { convertToBSTISOString } from '../AllFunctions';

export default function Ldjson({ news, catName, catSlug,DisplayCatName }) {
                ...
                {`
                    {
                        ...
                        "url": "${process.env.REACT_APP_FONT_DOMAIN_URL}details/${catSlug}/${news.ContentID}",
                        ...
                        "mainEntityOfPage": {
                          "@type": "WebPage",
                          "@id": "${process.env.REACT_APP_FONT_DOMAIN_URL}details/${catSlug}/${news.ContentID}"
                        },
                        "keywords": "${KeyWord}",
                ...
                {`
                    {
                        ...
                        "articleSection":"${catName}",
                        "description":"${DisplayCatName || catName + 'সর্বশেষ খবর :: দেশকালনিউজ'}",
                        "@type":"NewsArticle",
                        "@context":"http://schema.org"
                    }
                `}
