        ...
        <div className='page-bangla'>
            <main>
                <div className="container mt-3">
                    ...
                    <DocumentTitle title=' দেশকালনিউজ.কম :: যোগাযোগ' />
                    <div className="contact-area">  <div className="SectionTitle"><h1><Link to="/contact-us" onClick={scrollTop}><span className="ColorBox"></span>যোগাযোগ</Link></h1></div></div>
