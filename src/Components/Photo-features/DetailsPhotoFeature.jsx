                ...
                <div className="row">
                  <div className="col-lg-9 col-12 border-right-inner">
                    ...
                    <div className="mt-4 mb-2 d-contents d-sm-flex justify-content-between align-items-center">
                      <p className="VideoPublishDate mt-2"> <span>প্রকাশিত:</span> {album.created_at ? formatDateToBengali((album.created_at).toString()) : ""} </p>
                      <DSocialShare title={album.Title} contentID={album.AlbumID} />
                    </div>
                        ...
                        {ImageList.map((img) => {
                          return (
                            <div className="mb-4" key={img.ImagePath}>
                              <picture>
                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + img.ImagePath} alt={album.Title} title={album.Title} fetchpriority="high" className="img-fluid img100" style={{width: "100%", height:"auto"}} />
                              </picture>
                              <div className="DetailsTopCap">
                                <p className="DTopImgCaption">{img.Caption}</p>
                              </div>
                            </div>
                          )
                        }
                      ...
                      return (
                        ...
                        <div className="col-lg-3 col-12 d-flex" key={nc.AlbumID} >
                          <div className="DCatTop3tList" >
                            <Link rel="preload" as="image" to={"/photo/" + nc.AlbumID} onClick={scrollTop}>
                              <div className="row">
                                <div className="col-lg-12 col-sm-4 col-5">
                                  <div className="">
                                    {nc.thumbnail == null ?
                                      <picture>
                                        <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_LAZYL_IMG} alt={nc.Title} title={nc.Title} fetchpriority="high" className="img-fluid img100" />

                                      </picture> :
                                      <picture>
                                        <img src={process.env.REACT_APP_IMG_Path + nc.thumbnail} alt={nc.Title} title={nc.Title} fetchpriority="high" className="img-fluid img100" />
