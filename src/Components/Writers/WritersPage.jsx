...
export default function WritersPage() {
    ...
    useEffect(() => {
        ...
        axios
            .post(`${process.env.REACT_APP_API_URL}writers-contents`, formData)
            .then(({ data }) => {
                                                ...
                                                {nc.ImagePath ? (
                                                    <>
                                                        <div className="col-lg-2 col-sm-4 col-5">
                                                            {nc.ImagePath === null ?
                                                                <picture><img src={process.env.REACT_APP_LAZYL_IMG}  alt={nc.WriterName} title={nc.WriterName} fetchpriority="high"  style={{width: "100%", height:"auto"}} /></picture> :
                                                                <picture><img src={process.env.REACT_APP_IMG_Writer + nc.ImagePath} alt={nc.WriterName} title={nc.WriterName} fetchpriority="high"  style={{width: "100%", height:"auto"}}/></picture>}
                                                        </div>
