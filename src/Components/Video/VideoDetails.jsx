                                    ...
                                    <div className="col-lg-8 col-12 border-right-inner">
                                        ...
                                        <div className="mt-4 d-contents d-sm-flex justify-content-between align-items-center">
                                            {VideoDetails.create_date ? 
                                             <p className="VideoPublishDate mt-2"> <span>প্রকাশিত:</span> {VideoDetails.create_date ? formatDateToBengali((VideoDetails.create_date).toString()) : ""} </p> : 
                                             <p className="VideoPublishDate mt-2"> <span>প্রকাশিত:</span> {VideoDetails.update_date	 ? formatDateToBengali((VideoDetails.update_date	).toString()) : ""} </p>}
