                ...
                <div className="container">
                    <div className="DTitle">
                        <Link to={+ '/'} onClick={scrollTop}>
                            <div className="DTitleInner"><h1 className="DTitleInnerBar"><span>ভিডিও গ্যালারি</span></h1></div>
                        </Link>
                        <DocumentTitle title='দেশকালনিউজ.কম :: ভিডিও গ্যালারী' />
                        <VideoLdJson />
                    </div>
                                            ...
                                            <div className="row">
                                                <div className="col-lg-8 col-12">
                                                    <div className="DImgZoomBlock">
                                                        <picture><img src={process.env.REACT_APP_LAZYL_IMG} data-src={'https://img.youtube.com/vi/' + leadVideoTop.WebTVLinkCode + '/maxresdefault.jpg'} alt={leadVideoTop.WebTVHeading} title={leadVideoTop.WebTVHeading} fetchpriority="high" style={{width: "100%", height:"auto"}} /></picture>
                                                            ...
                                                            <Link to={"/videos/" + nc.WebTVID} onClick={scrollTop}>
                                                                <div className="row">
                                                                    <div className="col-lg-12 col-sm-4 col-5">
                                                                        <div className="DImgZoomBlock">
                                                                            <picture><img src={process.env.REACT_APP_LAZYL_IMG} data-src={'https://img.youtube.com/vi/' + nc.WebTVLinkCode + '/maxresdefault.jpg'} alt={nc.WebTVHeading} title={nc.WebTVHeading} fetchpriority="high"  style={{width: "100%", height:"auto"}}/></picture>
                                                                            <div className="card-videoGallery-icon"><i className="fa-solid fa-play"></i></div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <Link to={"/videos/" + nc.WebTVID} onClick={scrollTop}>
                                                    <div className="row">
                                                        <div className="col-lg-12 col-sm-4 col-5 videoIcon">
                                                            <div className="DImgZoomBlock">
                                                                <picture><img src={process.env.REACT_APP_LAZYL_IMG} data-src={"https://img.youtube.com/vi/" + nc.WebTVLinkCode + "/0.jpg"} alt={nc.WebTVHeading} title={nc.WebTVHeading}  fetchpriority="high" className="img-fluid img100" style={{width: "100%", height:"auto"}} /></picture>
                                                                <div className="card-videoGallery-icon"><i className="fa-solid fa-play"></i></div>
                                                            </div>
