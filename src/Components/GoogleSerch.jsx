...
export default function GoogleSerch() {
            ...
            {isLoading === false ?
                <div className="container mb-5">
                    ...
                    <div className="SPSecTitle">
                        <Link to="/keywordsearch" onClick={scrollTop}>
                            <div className="CategoryPageTitleTop mt-5">
                                <h2 className="CategoryPageTitle"><Link to="/keywordsearch"><span className="CategoryPageTitle "><span className='ColorBox'></span>খুঁজুন</span></Link>

                                </h2>
                            </div>
                            <DocumentTitle title='খুঁজুন :: দেশকালনিউজ.কম'></DocumentTitle>
                        </Link>
                    </div>
