...
export default function HealthTalkMobile() {
                                                    ...
                                                    <div className="Imgresize">
                                                        <picture>
                                                            {list.ImageThumbPath == null ?
                                                                ...
                                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + list.ImageThumbPath} alt={list.DetailsHeading} title={list.DetailsHeading} fetchpriority="high" className="img-fluid img100"
                                                                    style={{ width: "100%", height: "100%" }} />}
