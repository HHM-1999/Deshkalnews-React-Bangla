                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="section-heading">
                                <h2><i className="fa-solid fa-chevron-right"></i><Link to='/videos'>ভিডিও গ্যালারি</Link></h2>
                            </div>
                        </div>
                    </div>
                    {videos ? 
                        ...
                        <div className="col-lg-6 ">
                            <div className="video-big">
                                <Link to={"/videos/" + videos.WebTVID} onClick={scrollTop}>
                                        ...
                                        <picture>
                                            {videos.WebTVLinkCode === null ? (
                                                <img
                                                    ...
                                                    alt={videos.WebTVHeading}
                                                    title={videos.WebTVHeading}
                                                    fetchpriority="high"
                                                    className="img100"
                                                />
                                            ) : (
                                    ...
                                    <div className="Desc">
                                        <h3 className="Title">{videos.WebTVHeading}</h3>
