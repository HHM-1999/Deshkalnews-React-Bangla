...
// import DDivisionSearch from "./DDivisionSearch";
...
export default function Country() {
    ...
    useEffect(() => {
        ...
        axios
            .get(`${process.env.REACT_APP_API_URL}home-json-bn/generateCategory1.json`)
            .then(({ data }) => {
                if (data.length > 0) {
                    setList1(data[0]);
    ...
    return (
        <>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><i className="fa-solid fa-chevron-right"></i><Link to='/national' onClick={scrollTop}>জাতীয়</Link></h2>
                        </div>
                    </div>
                </div>
                <div className=" row">
                                                ...
                                                <div className="Imgresize">
                                                    <picture>
                                                        {list.ImageThumbPath == null ?
                                                            <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_LAZYL_IMG} alt={list.DetailsHeading} title={list.DetailsHeading} fetchpriority="high" className="img-fluid img100" style={{width: "120px", height:"100%"}} /> :
                                                            <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + list.ImageThumbPath} alt={list.DetailsHeading} title={list.DetailsHeading} fetchpriority="high" className="img-fluid img100" style={{width: "120px", height:"100%"}} />}
            ...
            <div className="seeMore">
                <Link className="btn btnMore" to='/national' onClick={scrollTop}>আরও...</Link>
            </div>
        </>
    )
