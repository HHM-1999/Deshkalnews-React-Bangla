...
export default function Events() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_API_URL}latest-event`)
            .then(({ data }) => {
                ...
                const eventUrl = `${process.env.REACT_APP_API_URL}home-json-bn/generateEvent${id}.json`;
                            ...
                            {bannerSrc ? (
                                <Link to={`/events/${eventData.Slug}`}>
                                    <div className="eventBanner">
                                        <img
                                            src={`${process.env.REACT_APP_DOMAIN_URL}media/bangla/event/${bannerSrc}`}
