...
export default function HealthTalk() {
    const [List1, setList1] = useState([])
    const [List2, setList2] = useState([])
    const [List3, setList3] = useState([])
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}home-json-bn/generateCategory22.json`)
            .then(({ data }) => {
                if (data.length > 0) {
                    setList1(data[0]);
        ...
        <>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="section-heading">
                        <h2><Link to='/health' onClick={scrollTop}><i className="fa-solid fa-chevron-right"></i>স্বাস্থ্যকথা</Link></h2>
                    </div>
                </div>
            </div>
            <div className="CommonSecNews3-wrapper">
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to='/health' onClick={scrollTop}>আরও...</Link>
                </div>
