...
export default function Econmics() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}home-json-bn/generateCategory7.json`)
            .then(({ data }) => {
                // if (data.length > 0) {
                setList1(data[0]);
                setList2(data[1]);
        ...
        <>
            <div className="row">
                <div className="col-12">
                    <div className="section-heading">
                        <Link to='/finance-and-trade' onClick={scrollTop}>
                            <h2><i className="fa-solid fa-chevron-right"></i>অর্থ ও বাণিজ্য</h2>
                        </Link>
                    </div>
                </div>
            </div>
            <div className="orthoniti-area">
                            ...
                            <Link to={"/" + List1.Slug + "/" + List1.ContentID} onClick={scrollTop}>
                                <div className="row">
                                    <div className="col-lg-4 Imgresize">
                                        <picture>
                                            {List1.ImageThumbPath == null ?
                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_LAZYL_IMG} alt={List1.DetailsHeading} title={List1.DetailsHeading} fetchpriority="high" className="img-fluid img100" width={120} height={67} />
                                                :
                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + List1.ImageThumbPath} alt={List1.DetailsHeading} title={List1.DetailsHeading} fetchpriority="high" className="img-fluid img100" width={120} height={67} />
                                ...
                                <div className="CommonLead">
                                    <Link to={"/" + List3.Slug + "/" + List3.ContentID} onClick={scrollTop} >
                                        <div className="row">
                                            <div className="col-lg-12 col-5 Imgresize">
                                                <picture>
                                                    {List3.ImageSmPath == null ?
                                                        <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_LAZYL_IMG} alt={List3.DetailsHeading} title={List3.DetailsHeading} fetchpriority="high" className="img-fluid img100" width={300} height={169}/>
                                                        :
                                                        <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + List3.ImageSmPath} alt={List3.DetailsHeading} title={List3.DetailsHeading} fetchpriority="high" className="img-fluid img100" width={300} height={169} />
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to='/finance-and-trade' onClick={scrollTop}>আরও...</Link>
                </div>
            </div >
