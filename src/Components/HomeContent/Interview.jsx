                                    ...
                                    <div className="col-lg-5 col-5">
                                        <div className="Imgresize">
                                            <picture>{nc.ImageThumbPath == null ?
                                                ...
                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + nc.ImageThumbPath} alt={nc.DetailsHeading} title={nc.DetailsHeading} className="img-fluid img100" width={120} height={67} />}</picture>
                                        </div>
                                    </div>
