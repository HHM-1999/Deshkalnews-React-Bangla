...
export default function PoliticsMobile() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}home-json-bn/generateCategory3.json`)
            .then(({ data }) => {
                if (data.length > 0) {
                    setList1(data[0]);
    ...
    return (
        <>
                ...
                <div className="col-12">
                    <div className="section-heading">
                        <Link to='/politics' onClick={scrollTop}>
                            <h2><i className="fa-solid fa-chevron-right"></i>রাজনীতি</h2></Link>
                    </div>
                </div>
            </div>
                                            ...
                                            <div className="Imgresize">
                                                <picture>
                                                    {nc.ImageThumbPath == null ?
                                                        <img src={process.env.REACT_APP_LAZYL_IMG} alt={nc.DetailsHeading} title={nc.DetailsHeading} className="img-fluid img100" width={120} height={67} />
                                                        :
            ...
            <div className="seeMore">
                <Link className="btn btnMore" to='/politics' onClick={scrollTop}>আরও...</Link>
            </div>
        </>
    )
