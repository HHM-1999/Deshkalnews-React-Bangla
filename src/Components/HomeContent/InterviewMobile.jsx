...
export default function InterviewMobile() {
    const [List1, setList1] = useState([])
    const [List2, setList2] = useState([])

    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}home-json-bn/generateCategory19.json`)
            .then(({ data }) => {
                if (data.length > 0) {
                    setList1(data[0]);
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><i className="fa-solid fa-chevron-right"></i><Link to="/interview" onClick={scrollTop}>সাক্ষাৎকার</Link></h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row">
                                <div className="col-lg-12 col-12 Imgresize">
                                    <picture>{List1.ImageSmPath == null ?
                                        ...
                                        <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + List1.ImageSmPath} alt={List1.DetailsHeading} title={List1.DetailsHeading} fetchpriority="high" className="img-fluid img100" width={300} height={169} />}</picture>
                                    ...
                                    <div className="col-lg-5 col-5">
                                        <div className="Imgresize">
                                            <picture>{nc.ImageThumbPath == null ?
                                                ...
                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + nc.ImageThumbPath} alt={nc.DetailsHeading} title={nc.DetailsHeading} fetchpriority="high" className="img-fluid img100" width={120} height={67} />}</picture>
                                        </div>
                                    </div>
