...
export default function Lifestyle() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}home-json-bn/generateCategory71.json`)
            .then(({ data }) => {
                if (data.length > 0) {
                    setList1(data[0]);
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><i className="fa-solid fa-chevron-right"></i><Link to='/lifestyle' onClick={scrollTop}>লাইফস্টাইল</Link></h2>
                        </div>
                    </div>
                </div>
                                            ...
                                            <Link to={"/details/" + nc.Slug + "/" + nc.ContentID} onClick={scrollTop}>
                                                <div className="row">
                                                    <div className="col-lg-12 col-5 Imgresize">
                                                        <picture>
                                                            {nc.ImageSmPath == null ?
                                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_LAZYL_IMG} alt={nc.DetailsHeading} title={nc.DetailsHeading} fetchpriority="high" className="img-fluid img100" style={{width: "300px", height:"100%"}}
 /> :
                                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + nc.ImageSmPath} alt={nc.DetailsHeading} title={nc.DetailsHeading} fetchpriority="high" className="img-fluid img100" style={{width: "300px", height:"100%"}}
 />}
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to='/lifestyle' onClick={scrollTop}>আরও...</Link>
                </div>
            </div>
        </>
    )
