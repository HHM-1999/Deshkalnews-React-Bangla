                                        ...
                                        <div className="DCatLeadTop">
                                            <div className="LiveVideoItem">
                                                {VideoNews1 && VideoNews1 ?
                                                    <Link rel="preload" as="image" to={"/english/photo/" + VideoNews1.AlbumID} onClick={scrollTop}>
                                                        <div className="row">
                                    ...
                                    <div className="col-lg-4 col-12 d-flex">
                                        <div className="DCatTop2">
                                            {VideoNews2 && VideoNews2 ?
                                                <Link rel="preload" as="image" to={"/english/photo/" + VideoNews2.AlbumID} onClick={scrollTop}>
                                                    <div className="row">
                                        ...
                                        return (
                                            <div className="col-lg-4 col-12 d-flex border-right-inner" key={nc.AlbumID}>
                                                <div className="DCatTop3tList" >
                                                    <Link to={"/english/photo/" + nc.AlbumID}>
                                                        <div className="row">
                                                            <div className="col-lg-12 col-sm-4 col-5">
                                                                <div className="">
                                                                    {nc.thumbnail == null ?
