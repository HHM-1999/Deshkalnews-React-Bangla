...
import { ForLazyLoaderImg, formatTimestamp, scrollTop } from '../Components/AllFunctions'
        ...
        <main>
           ...
           <HeaderEn /> */}
            <div className="container">
                ...
                <ArchiveLdJson />
                <h1 className="DTitleEng"><Link to="/english/archives"><span className="DTitleInner"><span className="DTitleInnerBar"><span>Archieves</span></span></span></Link></h1>
                <div className="row">
                        ...
                        news.map((nc) => (
                            ...
                            <div className="col-lg-6 col-sm-12" key={nc.ContentID}>
                                <div className="archiveListNews" >
                                    <Link rel="preload" as="image" to={"/english/details/" + nc.Slug + "/" + nc.ContentID} onClick={scrollTop}>
                                        <div className="row">
