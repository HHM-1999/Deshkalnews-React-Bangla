        ...
        <div className='page-english'>
            ...
            <main>
                <div className="container">
                    ...
                    <div className="SectionTitleEn"><h1><Link to="/english/terms-conditions" onClick={scrollTop}><span className="ColorBox"></span>Terms And Conditions for DeshKalNews.com</Link></h1></div>
