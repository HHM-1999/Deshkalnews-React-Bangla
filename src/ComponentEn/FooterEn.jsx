                            ...
                            <div className="col-lg-6 col-12 d-flex align-items-center justify-content-center">
                                <div className="footerMiddle">
                                    <div className="footer-logo">
                                        <a href="/english"> <img src={Logo} alt="DeshKalNews.com"
                                            title="DeshKalNews.com" />
                                        </a>
                                    </div>
                                    <ul className="footer-links">
                                        <li><a href="/english/about">ABOUT</a>
                                        </li>
                                        <li><a href="/english/contact-us">CONTACT</a>
                                        </li>
                                        <li><Link to="/english/archives" onClick={scrollTop}>ARCHIVE</Link>
                                        </li>
                                        <li><a href="/english/terms-conditions">TERMS</a>
                                        </li>
                                        <li><a href="/english/privacy-policy">POLICY</a>
                                        </li>
                                        <li><a href="/english/advertise">ADVERTISEMENT</a>
                                        </li>
                                    </ul>
