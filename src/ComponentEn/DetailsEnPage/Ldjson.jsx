...
import { convertToBSTISOString } from '../../Components/AllFunctions';
                ...
                {`
                    {
                        ...
                        "url": "${process.env.REACT_APP_FONT_DOMAIN_URL}english/details/${catSlugEn}/${news.ContentID}",
                        ...
                        "mainEntityOfPage": {
                          "@type": "WebPage",
                          "@id": "${process.env.REACT_APP_FONT_DOMAIN_URL}english/details/${catSlugEn}/${news.ContentID}"
                        },
                        "keywords": "${KeyWord}",
                ...
                {`
                    {
                        ...
                        "itemListElement":[
                            ...
                            },
                            {
                                ...
                                "position":2,
                                "item":{
                                    "@id":"${process.env.REACT_APP_FONT_DOMAIN_URL}english/${catSlugEn}",
                                    "name":"${catName}"
                                }
                            },
                            {
