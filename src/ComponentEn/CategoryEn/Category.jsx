                                ...
                                <div className="row">
                                    <div className="col-lg-8 col-12 d-flex ">
                                        <div className="DCatLeadTop">
                                            {catLeadNews1 && (
                                                <Link rel="preload" as="image" to={`/english/details/${catLeadNews1.Slug}/${catLeadNews1.ContentID}`} onClick={scrollTop}>
                                                    <div className="row">
                                    ...
                                    <div className="col-lg-4 col-12 d-flex">
                                        <div className="DCatTop2 align-self-stretch">
                                            {catLeadNews2 && (
                                                <Link rel="preload" as="image" to={`/english/details/${catLeadNews2.Slug}/${catLeadNews2.ContentID}`} onClick={scrollTop}>
                                                    <div className="row">
