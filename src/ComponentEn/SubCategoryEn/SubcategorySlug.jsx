                            ...
                            <div className="row">
                                <div className="col-lg-8 col-12 d-flex">
                                    <div className="DCatLeadTop">
                                        {catLeadNews1 && (
                                            <Link rel="preload" as="image" to={`/english/details/${catSlugEn}/${catLeadNews1.ContentID}`} onClick={scrollTop}>
                                                <div className="row">
                                ...
                                <div className="col-lg-4 col-12 d-flex">
                                    <div className="DCatTop2 align-self-stretch">
                                        {catLeadNews2 && (
                                            <Link rel="preload" as="image" to={`/english/details/${catSlugEn}/${catLeadNews2.ContentID}`} onClick={scrollTop}>
                                                <div className="row">
                                    ...
                                    {catLeadNews3.map(nc => (
                                        <div className="col-lg-4 col-12 d-flex border-right-inner" key={nc.ContentID}>
                                            <div className="DCatTop3tList align-self-stretch">
                                                <Link to={`/english/details/${catSlugEn}/${nc.ContentID}`} onClick={scrollTop}>
                                                    <div className="row">
                                                        <div className="col-lg-12 col-sm-4 col-5">
                                                            <div className="DImgZoomBlock">
