        ...
        return (
            <>
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading d-flex align-items-end">
                            <h2><a href="/english/business/economy"><i className="fa-solid fa-chevron-right"></i>Economy</a> </h2>
                ...
                <div className="multiple-news-wrap">
                    {List2 ?
                        <div className="CommonLead">
                            <Link to={"/english/details/" + List2.Slug + "/" + List2.ContentID} onClick={scrollTop} >
                                <div className="row">
                                    <div className="col-lg-12 col-5 Imgresize">
                                        <picture>
                                            {List2.ImageBgPath == null ?
                                                ...
                                                :
                                                <img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + List2.ImageBgPath} alt={List2.DetailsHeading} title={List2.DetailsHeading} className="img-fluid img100"  
                                                style={{width: "300px", height:"100%"}}/>
                ...
                <div className="seeMore">
                    <a className="btn btnMore" href="/english/business/economy">More...</a>
                </div>
            </>
        )
