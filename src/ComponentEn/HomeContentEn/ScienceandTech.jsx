    ...
    return (
        <>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><i className="fa-solid fa-chevron-right"></i><Link to='/english/science-and-tech' onClick={scrollTop}>Science and Tech</Link></h2>
                        </div>
                    </div>
                </div>
                <div className=" row">
                        ...
                        {list2.map((list, i) => {
                            return (
                                <div className="CommonLeadList" key={i}>
                                    <Link to={"/english/details/" + list.Slug + "/" + list.ContentID} onClick={scrollTop}>
                                        <div className="row">
            ...
            <div className="seeMore">
                <Link className="btn btnMore" to="/english/science-and-tech" onClick={scrollTop}>More...</Link>
            </div>
