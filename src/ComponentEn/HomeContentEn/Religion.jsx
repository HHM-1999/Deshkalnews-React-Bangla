        ...
        return (
            <>
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><Link to='/english/faith-and-religion' onClick={scrollTop}><i className="fa-solid fa-chevron-right"></i>Faith and Religion</Link></h2>
                        </div>
                    </div>
                </div>
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to="/english/faith-and-religion" onClick={scrollTop}>More...</Link>
                </div>
            </>
        )
    }
