...
export default function Weather() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_EN_API_URL}home-json-en/generateCategory12.json`)
            .then(({ data }) => {
                if (data.length > 0) {
                    setList2(data[0]);
        ...
        <>
            ...
            <div className="row">
                <div className="col-12">
                    <div className="section-heading d-flex align-items-end">
                        <h2><Link to="/english/weather" onClick={scrollTop}><i className="fa-solid fa-chevron-right"></i>Weather</Link> </h2>
                    </div>
                </div>
            </div>
            <div className="probash-sec">
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to="/english/weather" onClick={scrollTop}>More...</Link>
                </div>
            </div>
