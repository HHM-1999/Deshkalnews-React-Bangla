            ...
            <>
                <div className="Bissho-area">
                    <div className="row">
                        <div className="col-12">
                            <div className="section-heading">
                                <h2><i className="fa-solid fa-chevron-right"></i><Link to='/english/agriculture'>Agriculture</Link></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="seeMore">
                        <Link className="btn btnMore" to="/english/agriculture" onClick={scrollTop}>More...</Link>
                    </div>
                </div>
            </>
        )
