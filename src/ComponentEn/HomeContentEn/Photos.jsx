                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="section-heading">
                                <h2><Link to='/english/photo'><i className="fa-solid fa-chevron-right"></i>Photo Gallery</Link></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-lg-6 col-12 d-flex">
                                {photoList1 ?
                                    <div className="CommonLead2">
                                        <Link to={"/english/photo/" + photoList1.AlbumID} onClick={scrollTop} key={photoList1.AlbumID}>
                                            ...
                                            <div className="col-lg-12" key={i} >
                                                <div className="Common-list2">
                                                    <div className="Common-list2-details">
                                                        <Link to={"/english/photo/" + nc.AlbumID} onClick={scrollTop}>
                                                            <div className="row">
