            ...
            <>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <h2><Link to='/english/health'><i className="fa-solid fa-chevron-right"></i>Health</Link></h2>
                        </div>
                    </div>
                </div>
                <div className="CommonSecNews3-wrapper">
                    ...
                    <div className="seeMore">
                        <Link className="btn btnMore" to="/english/health" onClick={scrollTop}>More...</Link>
                    </div>
