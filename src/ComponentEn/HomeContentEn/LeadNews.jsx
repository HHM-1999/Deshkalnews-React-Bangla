...
import { ForLazyLoaderImg, scrollTop } from '../../Components/AllFunctions'
import SpecialTop from './SpecialTop'
// import eventBanner from '../../assets/media/common/july-year-english.jpg'
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-12 border-right-inner">
                            ...
                            <div className="DLeadNews">
                                <Link rel="preload" as="image" to={"/english/details/" + LeadData.categorySlug + "/" + LeadData.ContentID} onClick={scrollTop} key={LeadData.ContentID}>
                        ...
                        <div className="col-lg-3 col-12  order-lg-first border-right-inner">
                              ...
                              {/* <div className="short-event">
                                <Link to={"/english/tags/One Year of Uprising"}>
                                    ...
                                    <ul>
                                        {LeadData2.map((nc, i) => {
                                            return (
                                                ...
                                                {
                                                    nc.AltHomeTitle ?
                                                    <li><Link to={"/english/details/" + nc.categorySlug + "/" + nc.ContentID} onClick={scrollTop} key={i}>{nc.AltHomeTitle}</Link></li> :
                                                    <li><Link to={"/english/details/" + nc.categorySlug + "/" + nc.ContentID} onClick={scrollTop} key={i}>{nc.DetailsHeading}</Link></li>
                                                }
                                                </>
