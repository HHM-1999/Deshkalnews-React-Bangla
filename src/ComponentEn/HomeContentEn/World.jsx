...
export default function World() {
    ...
    try {
        useEffect(() => {
            axios
                .get(`${process.env.REACT_APP_EN_API_URL}home-json-en/generateCategory2.json`)
                .then(({ data }) => {
                    if (data.length > 0) {
                        setList1(data[0]);
                        setList2(data[1]);
            ...
            <>
                    ...
                    <div className="col-12">
                        <div className="section-heading">
                            <Link to='/english/world' onClick={scrollTop}>
                                <h2><i className="fa-solid fa-chevron-right"></i>World</h2>
                            </Link>
                        </div>
                    </div>
                </div>
                <div className="orthoniti-area">
                            ...
                            <div className="multiple-news-wrap">
                                {List3 ?
                                    <div className="CommonLead" key={List3.ContentID}>
                                        <Link to={"/english/details/" + List3.Slug + "/" + List3.ContentID} onClick={scrollTop} >
                                            <div className="row">
                                                <div className="col-lg-12 col-5 Imgresize">
                                                    <picture>
                    ...
                    <div className="seeMore">
                        <Link className="btn btnMore" to='/english/world' onClick={scrollTop}>More...</Link>
                    </div>
                </div >
            </>
        )
