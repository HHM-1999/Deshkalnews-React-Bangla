                ...
                <div className="leadTop3">
                    <div className="Common-list">
                        <div className="Common-list-details">
                            <Link to={"/english/details/" + LeadSpecial1.categorySlug + "/" + LeadSpecial1.ContentID} onClick={scrollTop}>
                                <div className="row">
                        ...
                        LeadSpecial2.map((nc, i) => {
                            return (
                                <div className="CommonLeadList2" key={i}>
                                    <Link to={"/english/details/" + nc.categorySlug + "/" + nc.ContentID} onClick={scrollTop}>
                                        <div className="row">
