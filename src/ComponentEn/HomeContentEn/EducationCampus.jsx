        ...
        <>
            <div className="row">
                ...
                <div className="section-heading d-flex align-items-end">
                        <h2><a href="/english/news/education"><i className="fa-solid fa-chevron-right"></i>Education</a> </h2>
                    </div>
                </div>
            </div>
            ...
            <div className="seeMore">
                <Link className="btn btnMore" to="/english/news/education" onClick={scrollTop}>More...</Link>
            </div>
