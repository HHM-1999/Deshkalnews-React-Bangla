                ...
                <section className="entertainment-area">
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <div className="section-heading">
                                    <h2><Link to='/english/entertainment' onClick={scrollTop}><i className="fa-solid fa-chevron-right"></i>Entertainment</Link></h2>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                        ...
                        <div className="seeMore">
                            <Link className="btn btnMore" to="/english/entertainment" onClick={scrollTop}>More...</Link>
                        </div>
                    </div>
                </section>
            </>
