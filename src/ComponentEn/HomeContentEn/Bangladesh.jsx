...
export default function Bangladesh() {
    ...
    try {
        useEffect(() => {
            axios
                .get(`${process.env.REACT_APP_EN_API_URL}home-json-en/generateCategory1.json`)
                .then(({ data }) => {
                    if (data.length > 0) {
                        setList1(data[0]);
                        setList2(data.slice(1, 4))
                        setList3(data.slice(4, 7))
                        setTimeout(function () {
                            lazyloaded = false
        ...
        return (
            <>
                <div className="row">
                    <div className="col-12">
                        <div className="section-heading">
                            <Link to='/english/news/bangladesh' onClick={scrollTop}>
                                <h2><i className="fa-solid fa-chevron-right"></i>Bangladesh</h2></Link>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div className="Imgresize">
                                                    <picture>
                                                        {nc.ImageThumbPath == null ?
                                                            <img src={process.env.REACT_APP_LAZYL_IMG} alt={nc.DetailsHeading} title={nc.DetailsHeading} className="img-fluid img100" style={{width: "100%", height:"auto"}} />
                                                            :
                ...
                <div className="seeMore">
                    <Link className="btn btnMore" to="/english/news/bangladesh" onClick={scrollTop}>More...</Link>
                </div>
            </>
        )
    }
